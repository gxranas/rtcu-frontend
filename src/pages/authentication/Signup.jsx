    ...
    <>
      <Container>
        <Content>
          ...
          <Label marginBottom="20px" marginRight="130px" marginTop="20px">Or, sign up with credentials</Label>

          <FormContent>
            <TextBox type="text" placeholder='Enter your full name' autoComplete='false'/>
          ...
          <Label marginTop="20px">Have an account? <PageLinks marginLeft="5px" to="/login">Login</PageLinks></Label>
        </Content>
      </Container>
    </>
  )
